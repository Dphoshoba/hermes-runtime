...
class MissionTypeRegistry:
    ...
    2. Via entry points under evosia.mission_types
    """
    ...
    def discover_entry_points(self) -> int:
        ...
        Looks for entry points under 'evosia.mission_types'.
        ...
        try:
            ...
            if hasattr(eps, "select"):
                mission_eps = eps.select(group="evosia.mission_types")
            else:
                mission_eps = eps.get("evosia.mission_types", [])
